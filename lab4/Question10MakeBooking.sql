...
LOCK TABLES Flight WRITE, Flight AS F READ, ContactPerson AS CP READ, Passenger AS P READ, Route AS Ro READ, ReservedFor AS R READ, ReservedFor READ, Reservation READ, Customer WRITE, Booking WRITE, BookedFor WRITE, Days AS D READ, Weekly_Schedule as W READ, Years AS Y READ;
